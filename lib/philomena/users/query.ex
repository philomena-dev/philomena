defmodule Philomena.Users.Query do
  ...
  # TODO: change `deleted_by_user_id`, `current_filter_id` and `forced_filter_id` to numeric
  defp fields do
    [
      int_fields:
      ...
      literal_fields:
        ~W(name slug role email deleted_by_user deleted_by_user_id current_filter_id forced_filter_id),
