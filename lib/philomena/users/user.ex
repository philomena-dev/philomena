defmodule Philomena.Users.User do
  ...
  def settings_changeset(user, attrs) do
    ...
    |> validate_inclusion(:theme, ~W(default dark red olddefault ponerpics-default manebooru-default manebooru-fuchsia manebooru-green manebooru-orange twibooru-default furbooru-default))
