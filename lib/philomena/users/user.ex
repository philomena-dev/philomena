defmodule Philomena.Users.User do
  ...
  def settings_changeset(user, attrs) do
    ...
    |> validate_inclusion(:theme, ~W(default dark red olddefault ponerpicsdefault maneboorudefault maneboorufuchsia maneboorugreen manebooruorange twiboorudefault furboorudefault))
