defmodule Philomena.DnpEntries.DnpEntry do
  ...
  def reasons do
    [
      ...
      {"Delayed Artist Upload Only",
       "I am an artist and will be uploading my own art. After a default of 6 months, users can post my art."},
      {"Delayed With Permission Only",
       "I am an artist and have given specific people permission to upload my art. After a default of 6 months, users can post my art."},
      {"Limited Edits",
      ...
      {"Separate Edits",
       "I am an artist and would like edits to be placed under a different artist tag."},
      {"User Interaction Lock",
       "I am an artist and would like my art to have comments disabled."},
      {"Video Hold",
       "I am a content creator and would like to delay my videos from being uploaded to #{Application.get_env(:philomena, :booru_name)}."},
      {"Image Hold",
       "I am an artist and would like to delay my art from being uploaded to #{Application.get_env(:philomena, :booru_name)}."},
      {"Artist Tag Change",
