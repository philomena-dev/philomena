defmodule Philomena.DnpEntries.DnpEntry do
  ...
  def reasons do
    [
      ...
      {"Video Hold",
       "I am a content creator and would like to delay my videos from being uploaded to Ponybooru."},
      {"Image Hold",
       "I am an artist and would like to delay my art from being uploaded to Ponybooru."},
      {"Artist Tag Change",
