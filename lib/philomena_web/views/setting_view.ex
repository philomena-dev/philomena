defmodule PhilomenaWeb.SettingView do
  ...
  def theme_options(conn) do
    [
	  ...
	  [key: "Poner Pics", value: "ponerpics-default", data: [theme_path: Routes.static_path(conn, "/css/ponerpics-default.css")]],
	  [key: "Manebooru Default", value: "manebooru-default", data: [theme_path: Routes.static_path(conn, "/css/manebooru-default.css")]],
